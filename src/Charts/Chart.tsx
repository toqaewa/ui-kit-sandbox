...
const chartDataConfig = [
  { key: "hasRevenueNet", dataKey: "Revenue Net", color: "#FF8B1F" },
  {
  ...
  { key: "hasRevenueGross", dataKey: "Revenue Gross", color: "#FF2C47" },
  { key: "hasProfit", dataKey: "Revenue", color: "#B15DE8" },
  { key: "hasExpensePerSeat", dataKey: "Expense Per Seat", color: "#FFBE99" },
  {
  ...
  { key: "hasDiscountLoyalty", dataKey: "Discount Loyalty", color: "#FFF047" },
  {
            ...
            >
              ...
              {chartSettings.hasRevenueNet && (
                <Line
                  ...
                  stroke="#FF8B1F"
                  dot={{ fill: "#FF8B1F" }}
                  activeDot={{ stroke: "#FF8B1F", strokeWidth: 2 }}
                />
              )}
              ...
              {chartSettings.hasAvgCheckPerGuest && (
                <Line
                  ...
                  stroke="#04E762"
                  dot={{ fill: "#04E762" }}
                  activeDot={{ stroke: "#04E762", strokeWidth: 2 }}
                />
              )}
              {chartSettings.hasAvgCheckPerGuest && isCompared && (
                <Line
                  yAxisId="left"
                  type="monotone"
                  dataKey="Avg Check Per Guest Prev"
                  stroke="#04E762"
                  strokeDasharray="3 3"
                  dot={{ fill: "#04E762" }}
                  activeDot={{ stroke: "#04E762", strokeWidth: 2 }}
              ...
              {chartSettings.hasIncomeAccumulated && (
                <Area
                  ...
                  stroke="#3370FF"
                  dot={{ fill: "#3370FF" }}
                  activeDot={{ stroke: "#3370FF", strokeWidth: 2 }}
                />
              )}
              {chartSettings.hasIncomeAccumulated && isCompared && (
                <Area
                  yAxisId="left"
                  type="monotone"
                  dataKey="Income Accumulated Prev"
                  stroke="#3370FF"
                  strokeDasharray="3 3"
                  dot={{ fill: "#3370FF" }}
                  activeDot={{ stroke: "#3370FF", strokeWidth: 2 }}
              ...
              {chartSettings.hasProfitGrossPerM2 && (
                <Line
                  ...
                  stroke="#9DFF6F"
                  dot={{ fill: "#9DFF6F" }}
                  activeDot={{ stroke: "#9DFF6F", strokeWidth: 2 }}
                />
              )}
              {chartSettings.hasProfitGrossPerM2 && isCompared && (
                <Line
                  yAxisId="left"
                  type="monotone"
                  dataKey="Profit Gross Per M² Prev"
                  stroke="#9DFF6F"
                  strokeDasharray="3 3"
                  dot={{ fill: "#9DFF6F" }}
                  activeDot={{ stroke: "#9DFF6F", strokeWidth: 2 }}
              ...
              {chartSettings.hasRevenueGross && (
                <Line
                  ...
                  stroke="#FF2C47"
                  dot={{ fill: "#FF2C47" }}
                  activeDot={{ stroke: "#FF2C47", strokeWidth: 2 }}
                />
              )}
              ...
              {chartSettings.hasProfit && (
                <Line
                  ...
                  stroke="#B15DE8"
                  dot={{ fill: "#B15DE8" }}
                  activeDot={{ stroke: "#B15DE8", strokeWidth: 2 }}
                />
              )}
              ...
              {chartSettings.hasExpensePerSeat && (
                <Line
                  ...
                  stroke="#FFBE99"
                  dot={{ fill: "#FFBE99" }}
                  activeDot={{ stroke: "#FFBE99", strokeWidth: 2 }}
                />
              )}
              ...
              {chartSettings.hasRevenueNetAccumulated && (
                <Area
                  ...
                  stroke="#DABFFF"
                  dot={{ fill: "#DABFFF" }}
                  activeDot={{ stroke: "#DABFFF", strokeWidth: 2 }}
                />
              )}
              {chartSettings.hasRevenueNetAccumulated && isCompared && (
                <Area
                  yAxisId="left"
                  type="monotone"
                  dataKey="Revenue Net Accumulated Prev"
                  stroke="#DABFFF"
                  strokeDasharray="3 3"
                  dot={{ fill: "#DABFFF" }}
                  activeDot={{ stroke: "#DABFFF", strokeWidth: 2 }}
              ...
              {chartSettings.hasDiscountLoyalty && (
                <Line
                  ...
                  stroke="#FFF047"
                  dot={{ fill: "#FFF047" }}
                  activeDot={{ stroke: "#FFF047", strokeWidth: 2 }}
                />
              )}
              ...
              {chartSettings.hasAvgCheckPerHour && (
                <Line
                  ...
                  stroke="#DCD8D3"
                  dot={{ fill: "#DCD8D3" }}
                  activeDot={{ stroke: "#DCD8D3", strokeWidth: 2 }}
                />
              )}
              {chartSettings.hasAvgCheckPerHour && isCompared && (
                <Line
                  yAxisId="left"
                  type="monotone"
                  dataKey="Avg Check Per Hour Prev"
                  stroke="#DCD8D3"
                  strokeDasharray="3 3"
                  dot={{ fill: "#DCD8D3" }}
                  activeDot={{ stroke: "#DCD8D3", strokeWidth: 2 }}
              ...
              {chartSettings.hasAvgCheckPerTable && (
                <Line
                  ...
                  stroke="#FF8ADE"
                  dot={{ fill: "#FF8ADE" }}
                  activeDot={{ stroke: "#FF8ADE", strokeWidth: 2 }}
                />
              )}
              {chartSettings.hasAvgCheckPerTable && isCompared && (
                <Line
                  yAxisId="left"
                  type="monotone"
                  dataKey="Avg Check Per Table Prev"
                  stroke="#FF8ADE"
                  strokeDasharray="3 3"
                  dot={{ fill: "#FF8ADE" }}
                  activeDot={{ stroke: "#FF8ADE", strokeWidth: 2 }}
              ...
              {chartSettings.hasChecksCount && (
                <Line
                  ...
                  stroke="#63C7FF"
                  dot={{ fill: "#63C7FF" }}
                  activeDot={{ stroke: "#63C7FF", strokeWidth: 2 }}
                />
              )}
